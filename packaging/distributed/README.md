...
This packaging is intentionally separate from the Unraid plugin package. It installs the distributed controller/node components under a versioned `/opt/ci-runner-farm/releases/<version>-<platform>` directory and atomically repoints `/opt/ci-runner-farm/current`.
