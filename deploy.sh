...
ssh "$HOST" "mkdir -p '$DEST/include' '$DEST/assets/icons'"
scp -q \
  "$SRC/RunnerFarm.page" \
  "$SRC/RunnerFarmDashboard.page" \
  "$SRC/RunnerFarmFleet.page" \
  "$SRC/RunnerFarmHistory.page" \
  "$SRC/RunnerFarmLogs.page" \
  "$SRC/RunnerFarmSettings.page" \
  "$SRC/RunnerFarmPools.page" \
  "$SRC/RunnerFarmImage.page" \
  "$SRC/default.cfg" \
...
scp -q "$SRC"/assets/icons/*.svg "$HOST:$DEST/assets/icons/"
