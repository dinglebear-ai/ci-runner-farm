...
make_tgz() {
  ...
  chmod 0755 "$package_root/include/runner-container-adapter.sh"
  chmod 0755 "$package_root/include/runner-distributed-adapter.sh"
...
chmod 0755 "\$PLGDIR/include/runner-container-adapter.sh"
chmod 0755 "\$PLGDIR/include/runner-distributed-adapter.sh"
