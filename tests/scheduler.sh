...
trap 'rm -rf "$tmp"' EXIT
cat >"$tmp/demand" <<'EOF'
rust|5|1|0|0|0|0|auto|4000|8589934592|1
python|8|1|0|0|0|0|auto|1000|2147483648|1
typescript|7|1|0|0|0|0|auto|1000|2147483648|1
go|3|1|0|0|0|0|auto|2000|4294967296|1
ops|1|0|0|0|0|0|2|500|1073741824|1
EOF
...
cat >"$tmp/charged" <<'EOF'
python|3|1|4|2|0|0|8|1000|2147483648|1
rust|2|0|0|2|1|1|8|4000|8589934592|1
EOF
scheduler_plan "$tmp/charged" 8000 17179869184 0 1 >"$tmp/out"
grep -q '^python|4|0|none|none|0|0|0$' "$tmp/out"
grep -q '^rust|2|0|none|none|0|1|1$' "$tmp/out"
