...
single_distributed='[{"id":"default","max_concurrency":9,"resources":{"cpu_millis":1000,"memory_bytes":4294967296},"preferred_cpu_millis":2000,"required_os":"linux","required_arch":"x86_64","required_backend":"container","required_capabilities":["container","github-actions"],"work_folder":"_work"}]'
...
v2_distributed='[{"id":"rust","max_concurrency":5,"resources":{"cpu_millis":1000,"memory_bytes":17179869184},"preferred_cpu_millis":4000,"required_os":"linux","required_arch":"arm64","required_backend":"container","required_capabilities":["container","github-actions"],"work_folder":"_work"},{"id":"python","max_concurrency":2,"resources":{"cpu_millis":1000,"memory_bytes":4294967296},"preferred_cpu_millis":2000,"required_os":"linux","required_arch":"arm64","required_backend":"container","required_capabilities":["container","github-actions"],"work_folder":"_work"}]'
