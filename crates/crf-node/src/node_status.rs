...
impl NodeStatusProjection {
    pub fn connecting(detail_code: NodeStatusDetail, observed_at_unix_ms: u64) -> Self {
        Self {
            schema_version: 1,
    ...
    pub fn ready(observed_at_unix_ms: u64) -> Self {
        Self {
            schema_version: 1,
    ...
    pub fn failed(detail_code: NodeStatusDetail, observed_at_unix_ms: u64) -> Self {
        Self {
            schema_version: 1,
...
mod tests {
    ...
    fn projection_contains_only_fixed_nonsecret_fields() {
        let encoded = serde_json::to_value(NodeStatusProjection::connecting(
    ...
    fn writes_ready_status_atomically() {
        ...
        write_atomic(&path, &NodeStatusProjection::ready(99)).expect("status writes");
